package com.kotkit.basic.executor.humanizer
 ...
 *
 * Optimized for faster execution while maintaining human-like behavior.
 * Original values were too slow for practical use.
 */
data class BasicHumanizerConfig(
    ...
    val durationMin: Long = 50,
    val durationMax: Long = 120,
    val durationMode: Long = 80,

    // Pre-action delay (reduced from 150-600ms to 50-200ms)
    val delayMin: Long = 50,
    val delayMax: Long = 200,
    val delayMode: Long = 100,

    // Post-action delay (reduced from 200-800ms to 100-300ms)
    val postDelayMin: Long = 100,
    val postDelayMax: Long = 300,
    val postDelayMode: Long = 150,
