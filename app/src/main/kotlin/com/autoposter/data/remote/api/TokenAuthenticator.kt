...
class TokenAuthenticator @Inject constructor(
    ...
    private fun refreshTokenSync(refreshToken: String): String? {
        ...
        val baseUrl = encryptedPreferences.serverUrl ?: "https://api.autoposter.com/"
        ...
        return try {
            ...
            if (response.isSuccessful) {
                ...
                val authResponse = gson.fromJson(responseBody, com.autoposter.data.remote.api.models.AuthResponse::class.java)
